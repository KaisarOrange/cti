...
<div class="flex flex-col lg:flex-row bg-white items-center justify-center gap-5">
	<div class="m-auto"><img src="logo.png" alt="" /></div>
	<div class="bg-blue-200 py-5 px-20 lg:w-1/2 flex flex-col items-center justify-center">
		...
		>
			...
			<form class="w-full flex flex-col gap-3 mt-10" on:submit|preventDefault={sendEmail}>
				...
				<button
					class="border px-2 py-1 mt-5 rounded-md bg-[#0162AE] text-white font-semibold"
					type="submit"
