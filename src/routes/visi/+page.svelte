	...
	<div class="flex gap-10 justify-center mb-10 flex-wrap">
		<div class="flex flex-col bg-white py-2 px-4 rounded-md w-1/4">
			...
			<div class="font-semibold text-[#0162AE]">
				Untuk berkontribusi pada pertumbuhan ekonomi dan meningkatkan standar hidup masyarakat di
				Indonesia.
			</div>
		</div>
		<div class="flex flex-col bg-white py-2 px-4 rounded-md w-1/4">
		...
		<div class="flex flex-col bg-white py-2 px-4 rounded-md w-1/4">
			...
			<div class="font-semibold text-[#0162AE]">
				Untuk memperoleh berbagai keterampilan dan pengetahuan dari Jepang demi masa depan yang
		...
		<div class="flex flex-col bg-white py-2 px-4 rounded-md w-1/4">
			...
			<div class="font-semibold text-[#0162AE]">
				Untuk memberikan kesempatan bagi pemuda Indonesia untuk menjadi individu yang mandiri
				melalui pelatihan dan mendapatkan pengetahuan di Jepang.
			</div>
		</div>
		<div class="flex flex-col bg-white py-2 px-4 rounded-md w-1/4">
			<div class="flex justify-between">
			...
			<div class="font-semibold text-[#0162AE]">
				Untuk menyampaikan budaya kerja Jepang, tradisi, dan etika profesional kepada pemuda
...
<style>
	.bg-image {
		background-image: url('/gambar13.png'); /* Reference the image correctly */
	...
	.content {
		position: relative; /* Ensure the inner content has its own stacking context */
		z-index: 2; /* Make sure this content is above the overlay */
	}
</style>
