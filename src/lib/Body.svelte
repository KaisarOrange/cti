<div class="mt-20">
	<h2 class="text-2xl w-1/2 font-bold text-[#0162AE] text-center m-auto">
		Membangun SDM terbaik melalui pendidikan vokasi dengan visi memenuhi kebutuhan tenaga kerja
		Jepang
	</h2>
	<div
		class="flex items-center justify-center gap-x-10 bg-white w-2/3 m-auto rounded-md p-10 mt-20 flex-wrap lg:flex-nowrap"
	>
